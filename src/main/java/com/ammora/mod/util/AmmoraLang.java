...
public class AmmoraLang {
    ...
    public static String guiStr(String subKey, Object... args) {
        return str("gui.ammora." + subKey, args);
    }
    ...
    public static String messageStr(String subKey, Object... args) {
        return str("message.ammora." + subKey, args);
    }
    ...
    public static String translateNotification(String msg) {
        ...
        if (msg.startsWith("key:")) {
            ...
            if (res.equals(key) && !key.startsWith("gui.ammora.") && !key.startsWith("message.ammora.")) {
                String candidateMsg = str("message.ammora." + key, args);
                if (!candidateMsg.equals("message.ammora." + key)) {
                    return candidateMsg;
                }
                String candidateGui = str("gui.ammora." + key, args);
                if (!candidateGui.equals("gui.ammora." + key)) {
                    return candidateGui;
                }
            }
            return res;
