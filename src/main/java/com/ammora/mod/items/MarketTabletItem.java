...
public class MarketTabletItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(com.ammora.mod.util.AmmoraLang.tooltip("market_tablet.1"));
        tooltipComponents.add(com.ammora.mod.util.AmmoraLang.tooltip("market_tablet.2"));
        tooltipComponents.add(com.ammora.mod.util.AmmoraLang.tooltip("market_tablet.3"));
    }
}
