...
public class ColdWalletItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(com.exchange.mod.util.ExchangeLang.tooltip("cold_wallet.1"));
        tooltipComponents.add(com.exchange.mod.util.ExchangeLang.tooltip("cold_wallet.2"));
        tooltipComponents.add(com.exchange.mod.util.ExchangeLang.tooltip("cold_wallet.3"));
        tooltipComponents.add(com.exchange.mod.util.ExchangeLang.tooltip("cold_wallet.4"));
    }
}
