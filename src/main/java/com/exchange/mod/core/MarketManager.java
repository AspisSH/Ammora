...
// --- DELIVERY CONTRACTS METHODS ---
    ...
    private final List<com.exchange.mod.datapack.ContractTemplate> contractTemplates = new java.util.concurrent.CopyOnWriteArrayList<>();

    public void setContractTemplates(List<com.exchange.mod.datapack.ContractTemplate> templates) {
        this.contractTemplates.clear();
        this.contractTemplates.addAll(templates);
    }

    public List<com.exchange.mod.datapack.ContractTemplate> getContractTemplates() {
